...
class TrapesiumScreen(Screen):
    def __init__(self, **kwargs):
        ...
        self.imagetrapesium = Image(source = "trapesium.png",
                               size_hint=(1, None),
                               height=dp(150),
                               allow_stretch=True,
                               keep_ratio=True)
        layout.add_widget(self.imagetrapesium)

        # Rumus

        self.labelRumus = Label(text = "Rumus Luas Trapesium = ½ × (a + b) × tinggi",
                           font_size=sp(18),
                           color=(0,0,0,1)
                           )
        ...
        self.input_a = TextInput(hint_text="Masukkan sisi atas (a)",
                                  multiline=False,
                                  input_filter="float",
                                  size_hint=(0.8,None),
                                  height= dp(45),
        ...
        self.input_b = TextInput(hint_text="Masukkan sisi bawah (b)",
                                   multiline=False,
                                   input_filter="float",
                                   size_hint=(0.8,None),
                                   height=dp(45),
        ...
        self.input_tinggi = TextInput(hint_text="Masukkan tinggi trapesium",
                                   multiline=False,
                                   input_filter="float",
                                   size_hint=(0.8,None),
                                   height=dp(45),
